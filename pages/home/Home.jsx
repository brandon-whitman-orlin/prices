...
function Home() {
    ...
    useEffect(() => {
        const fetchGasData = async () => {
            try {
                const response = await axios.get('http://localhost:5000/api/gas'); // Your backend API
        ...
        const fetchEggData = async () => {
            try {
                const response = await axios.get('http://localhost:5000/api/egg'); // Your backend API
